...
public class Studentprogram {
	...
	Studentprogram(String name,int age,int subject1m,int subject2m, int subject3m,char section,char gender){
	...
	Studentprogram(String name,int age,int subject2m, int subject3m,char section,char gender){
